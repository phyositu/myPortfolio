...
import { CanvasRevealEffect } from "@/components/ui/CavasRevealEffect";
            ...
            <section className="w-full py-20">
                ...
                <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                    <Card title="Planning & Strategy"
                        ...
                        description="We'll collaborate to map out your
                            website's goals, target audience, and key
                            ffunctionalities. We'll discuss things like
    ...
    return (
        <div>
            <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-2 text-white backdrop-blur-3xl text-3xl font-bold">
                    {order}
                </span>
            </button>
        </div>
