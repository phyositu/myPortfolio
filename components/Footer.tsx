    ...
    return (
        <footer className="w-full pb-10 mb-[100px] md:mb-5" id="contact">
            <div className="flex flex-col items-center">
                ...
                text-center">Reach out to me today and let &apos;s discuss how I can
                    help you achieve you goals.
                </p>
                <a href="mailto:phyosithuaung28@gmail.com">
                    <MagicButton
            ...
            justify-between items-center">
                ...
                md:font-normal font-light">Copyright &copy; 2024 Adrian
                </p>
